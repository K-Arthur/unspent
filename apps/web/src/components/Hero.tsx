    ...
    <section className="py-20 px-4">
      <div className="max-w-4xl mx-auto text-center">
        <div
          ...
          role="status"
          aria-label="Now available on TestFlight"
        >
          <span className="text-xl" aria-hidden="true">🎉</span>
          <span className="text-sm font-medium text-text">Now Available on TestFlight</span>
        </div>

        <h1 className="text-5xl md:text-6xl font-bold text-text mb-6 leading-[1.15]">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link href="https://apps.apple.com" className="btn-primary text-lg" rel="noopener">
